...
export default function About() {
  const arrData = [
    {
      img: car,
      title: "ООО ТАХОДРАЙВЕР ЗАНИМАЕТСЯ ПРОДАЖЕЙ И УСТАНАВКОЙ ТАХОГРАФОВ",
      _id: "8dbaf3ca-f523-4613-a06b-437eeb79e61e",
    },
    {
      img: car2,
      title: "У НАС ВЫ МОЖЕТЕ ЗАКАЗАТЬ КАРТУ ВОДИТЕЛЯ ЛЮБОГО ТИПА",
      _id: "df710270-2db0-4345-bca5-cfe4bed46c70",
    },
    {
      img: car3,
      title: "ВЫ МОЖЕТЕ ПРИОБРЕСТИ У НАС ТАХОГРАФЫ Б/У",
